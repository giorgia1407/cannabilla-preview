...
const SLIDES: Slide[] = [
  {
    ...
    eyebrow: "COSMESI NATURALE · MADE IN ITALY",
    heading: "Cannabilla",
    sub: "Cosmetici naturali all'olio di semi di canapa, ricco di omega 3 e 6. Formulati nel cuore dei Monti Sibillini.",
    cta: { label: "SCOPRI LA LINEA", kind: "scroll", href: "#categorie" },
  },
  {
    image: ATMOSPHERE.vineyard,
    alt: "Piante di canapa al tramonto",
    eyebrow: "ATTIVI VEGETALI NATURALI",
    heading: "La Forza della Canapa",
    sub: "Attivi vegetali e olio di semi di canapa per la cura di viso, corpo e capelli. Il meglio della cosmesi botanica italiana.",
    cta: { label: "ESPLORA I PRODOTTI", kind: "link", href: "/categoria/viso" },
  },
  {
    image: ATMOSPHERE.tasting,
    alt: "Rituale di bellezza con cosmetici alla canapa",
    eyebrow: "SPEDIZIONE IN TUTTA ITALIA",
    heading: "La tua routine naturale",
    sub: "Ordina via WhatsApp e ricevi i tuoi cosmetici a casa. Spedizione gratuita sopra €25.",
    cta: {
      label: "ORDINA VIA WHATSAPP",
      kind: "whatsapp",
      href: getWhatsAppUrl(
        "Ciao Cannabilla! Vorrei ordinare alcuni prodotti della linea di cosmetici alla canapa.",
      ),
    },
  },
];
