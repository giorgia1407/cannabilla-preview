...
const INFORMAZIONI: FooterLink[] = [
  ...
  { label: "La nostra selezione", href: "/categoria/viso" },
  { label: "Hempilla", href: "/categoria/hempilla" },
  // TODO Phase 2: link to real pages when Sarang builds these.
  { label: "Rivenditori", href: "#" },
  { label: "Ingredienti e attivi", href: "#" },
        ...
        <div>
          ...
          <div className="mt-4 overflow-hidden rounded-lg border border-border">
            <iframe
              ...
              src="https://www.google.com/maps?q=Via%20Caccianebbia%2010%2C%2063857%20Amandola%20FM&output=embed"
              width="100%"
              height="180"
              loading="lazy"
