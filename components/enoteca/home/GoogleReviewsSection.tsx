...
const REVIEWS = [
  {
    name: "Marco R.",
    when: "2 settimane fa",
    text: "Crema viso all'olio di canapa davvero eccezionale: pelle morbida e idratata fin dalla prima settimana. Profumo naturale e delicato.",
  },
  {
    name: "Giulia S.",
    when: "1 mese fa",
    text: "Spedizione rapidissima e prodotti confezionati con cura. Amo che siano naturali e cruelty-free. Ormai il mio brand di riferimento.",
  },
  {
    name: "Alessandro T.",
    when: "1 mese fa",
    text: "Ottima consulenza per la mia routine. Il balsamo per barba alla canapa è fantastico, nutre senza ungere. Qualità altissima.",
  },
  {
    name: "Francesca M.",
    when: "2 mesi fa",
    text: "Ingredienti naturali e attivi vegetali che si sentono sulla pelle. Consulenza gentile via WhatsApp. Consigliatissimo.",
  },
];
