...
function LogoLink({
  ...
  return (
    <Link href="/" onClick={onClick} aria-label="Cannabilla — home" className={className}>
...
function BusinessPill({ onClick, className = "" }: { onClick?: () => void; className?: string }) {
  return (
    <a
      href={getWhatsAppUrl(
        "Ciao Cannabilla! Sono un cliente business e vorrei conoscere le condizioni riservate.",
      )}
      target="_blank"
      rel="noopener noreferrer"
      onClick={onClick}
    ...
    <>
      ...
      >
        <div className="flex h-16 shrink-0 items-center justify-between border-b border-border px-5">
          <Link href="/" onClick={onClose} aria-label="Cannabilla — home">
