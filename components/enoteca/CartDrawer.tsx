              ...
              <>
                ...
                <div className="shrink-0 border-t border-line bg-white px-5 py-4">
                  ...
                  <Link
                    href="/cassa"
                    onClick={closeCart}
                    className="mt-3 inline-flex min-h-[52px] w-full items-center justify-center gap-2 rounded-full bg-gold px-6 text-[16px] font-bold uppercase tracking-wide text-charcoal shadow-gold-cta transition-colors hover:bg-gold-deep hover:text-white"
                  >
                    {t("cart.order")}
                  </Link>
                  <a
                    ...
                    className="mt-2 inline-flex min-h-[46px] w-full items-center justify-center gap-2 rounded-full border border-line bg-white px-6 text-[14px] font-bold uppercase tracking-wide text-[#128C4A] transition-colors hover:bg-cream-deep"
                  >
                    <WhatsAppIcon className="h-5 w-5" /> Chiedi su WhatsApp
                  </a>
